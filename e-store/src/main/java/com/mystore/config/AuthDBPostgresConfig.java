...
@EnableJpaRepositories( basePackages = "com.mystore.jpa.auth.repository", entityManagerFactoryRef = "authEntityManager", transactionManagerRef = "authTransactionManager" )
@Profile( "postgresql" )
public class AuthDBPostgresConfig 
{
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory()
	{
        ...
        em.setPackagesToScan( new String[] { "com.mystore.jpa.auth.entity" } );
